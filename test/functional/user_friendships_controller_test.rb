  ...
  context "#index" do
    ...
    context "when logged in" do
      setup do
        ...
        @friendship2 = create(:accepted_user_friendship, user: users(:jim), friend: create(:user, first_name: 'Active', last_name: 'Friend'))
  ...
  context "#new" do
    ...
    context "when logged in" do
      ...
      should "assign a user friendship with the user as current user" do
        get :new, friend_id: users(:jim).profile_name
        assert_equal assigns(:user_friendship).user, users(:william)
      end
